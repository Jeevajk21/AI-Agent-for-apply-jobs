...
*Tailored for: **Investment Analyst – Private Markets** at **Schroders***  
*ATS Match Score: **93/100***
...
`DCF FCFF Unilever valuation`, `CAPM FTSE 350 analysis`, `Bloomberg Terminal`, `Python`, `R panel regression`, `equity research`
