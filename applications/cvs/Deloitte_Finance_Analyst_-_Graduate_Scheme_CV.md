...
*Tailored for: **Finance Analyst – Graduate Scheme** at **Deloitte***  
...
`financial modelling`, `Excel VBA automation`, `variance analysis`, `client-facing analysis Accenture`, `CMA qualification`
